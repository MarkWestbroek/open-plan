...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "openplan"),
        "USER": config("DB_USER", "openplan"),
        "PASSWORD": config("DB_PASSWORD", "openplan"),
...
REST_FRAMEWORK["DEFAULT_RENDERER_CLASSES"] = (
    REST_FRAMEWORK["DEFAULT_RENDERER_CLASSES"]
) + ("openplan.utils.renderers.ProblemJSONRenderer",)

REST_FRAMEWORK["DEFAULT_SCHEMA_CLASS"] = "openplan.utils.schema.AutoSchema"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "openplan.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "openplan.wsgi.application"
...
AUTHENTICATION_BACKENDS = [
    ...
    "openplan.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "openplan_sessionid"
...
CSRF_FAILURE_VIEW = "openplan.accounts.views.csrf_failure"
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "openplan"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"openplan {ENVIRONMENT}",
