...
from openplan.accounts.views.password_reset import PasswordResetView
...
admin.site.site_header = "Open Plan admin"
admin.site.site_title = "Open Plan admin"
admin.site.index_title = "Open Plan dashboard"
