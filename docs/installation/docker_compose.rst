...
This installation is meant for people who want to just try out Open Plan on
their own machine.
...
* Runs against the latest version of Open Plan, which may contain bugs.
...
1. Download the project as ZIP-file:
   ...
   .. code:: bash
      ...
      $ wget https://github.com/maykinmedia/open-plan/archive/refs/heads/main.zip -O main.zip
      $ unzip main.zip
      $ cd open-plan-main
...
2. Start the docker containers with ``docker compose``. If you want to run the
   ...
   .. code:: bash
      ...
      [+] Running 5/5
       ⠿ Network open-plan-main_default    Created      0.0s
       ⠿ Container open-plan-main-db-1     Created      0.2s
       ⠿ Container open-plan-main-web-1    Created      0.1s
