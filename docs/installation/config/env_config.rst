...
* ``ELASTIC_APM_SERVICE_NAME``: Name of the service for this application in Elastic APM. Defaults to ``openplan - <environment>``.
...
* ``DB_NAME``:  Defaults to: ``openplan``.
* ``DB_USER``:  Defaults to: ``openplan``.
* ``DB_PASSWORD``:  Defaults to: ``openplan``.
...
* ``DEFAULT_FROM_EMAIL``:  Defaults to: ``openplan@example.com``.
...
* ``RELEASE``:  Defaults to: ``846f087185d89a0897cff63cc27749e94b795c40``.
