...
Updating an Open Plan installation
==================================

Software receives new features and bugfixes all the time, and Open Plan is no different.
At some point, you'll want to update to a newer version of Open Plan - be it a patch
