...
A clean installation of Open Plan has no existing data, it's up to the service provider
and/or the users to set up Open Plan to your liking.

To be able to do anything in the Open Plan admin interface, you need a user account
with sufficient permissions, typically a superuser. Open Plan has a couple of mechanisms
