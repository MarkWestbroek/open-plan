...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       $ git clone git@github.com:maykinmedia/open-plan.git
       $ cd open-plan

3. At this point you can already built the Docker image and run Open Plan.
...
``src/openplan/conf/local.py``. You can also set certain common
...
All settings for the project can be found in `src/openplan/conf``.
