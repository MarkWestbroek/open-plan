...
Open Plan makes use of quite a bit of Continuous Integration tooling to
...
Tagging will ensure that a Docker image ``maykinmedia/open-plan:1.0.0`` is published.
